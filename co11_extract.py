...
###################################################################################################
# co11_extract : On extrait de fichier de base les données voulue pour chaque participation
###################################################################################################
class co11Extract(hraiExtract) :
...
ext = co11Extract()
ext.prepare_training('./data/plat_2016_16.csv', './data/train2.hrd', './data/dev2.hrd')